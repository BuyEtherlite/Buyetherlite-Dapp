...
const Coin = (props: CoinProps) => {
  ...
  if (
    ...
    config?.erc20etl[name.toLowerCase()]?.icon
  ) {
  ...
  if (config?.erc20etl[name.toLowerCase()]?.iconBgColor) {
    style.backgroundColor = config.erc20etl[name.toLowerCase()].iconBgColor
  }
