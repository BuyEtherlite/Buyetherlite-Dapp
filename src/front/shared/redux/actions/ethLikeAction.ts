...
export default {
  ...
  ETL: new EthLikeAction({
    coinName: 'ETL Token',
    ticker: 'ETL',
    privateKeyName: 'eth',
    chainId: externalConfig.evmNetworks.ETL.chainId,
    explorerName: 'etlscan',
    explorerLink: externalConfig.link.etlscan,
    explorerApiKey: externalConfig.api.etherlite_ApiKey,
    adminFeeObj: externalConfig.opts?.fee?.etl,
    web3: new Web3(new Web3.providers.HttpProvider(externalConfig.web3.etl_provider)),
  }),
