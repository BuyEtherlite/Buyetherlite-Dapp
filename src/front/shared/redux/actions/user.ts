...
const sign = async () => {
  await metamask.web3connect.onInit( async () => {
    ...
    actions.etl.login(ethPrivateKey, mnemonic)
...
const getBalances = () => {
  ...
  return new Promise(async (resolve) => {
    const balances = [
      ...
      { func: actions.etl.getBalance, name: 'etl' },
...
const getText = () => {
  ...
  let text = `
    ...
    # ETL CHAIN
    \r\n
    ETL address: ${etlData.address}\r\n
    Private key: ${etlData.privateKey}\r\n
    \r\n
    # ARBITRUM CHAIN
    \r\n
